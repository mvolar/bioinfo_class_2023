...
Create a bash script which takes user input and creates that many files empty files in a new directory. (hint use "read" function to get and store the read variable in your program)
